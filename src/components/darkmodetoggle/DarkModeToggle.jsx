...
import { changeScreenMode } from '../../features/darkModeSlice';
...
const DarkModeToggle = () => {
    ...
    const toggleDarkMode = () => {
        dispatch(changeScreenMode(!isDarkModeOn))
    }

  return (
    <div className='darkmode-toggle-box'>
         <input className='darkmodetoggler' checked={!isDarkModeOn} type='checkbox' id='darkmode-toggle'/>
         <label onClick={()=>{toggleDarkMode()}} for="darkmode-toggle">
